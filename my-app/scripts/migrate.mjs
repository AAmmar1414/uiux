...
const {
  NEXT_PUBLIC_SANITY_PROJECT_ID="3uzipn5o", // Sanity project ID
  NEXT_PUBLIC_SANITY_DATASET="production", // Sanity dataset (e.g., "production")
  NEXT_PUBLIC_SANITY_AUTH_TOKEN="skruz0xMF3Uh9MJYf2hQwTQgndfO2L9g1MVzbaULK5QiyYypLgSUHNxkqHKX3zvYZDWTH5U1qA8xcsCL6bchGdSDkafPS9pk3AN6RT8HhItif4f2eVcsDTUqjO8u0bSmMdRPrOl9wtI7vRstHrYzcYeiLy86pOlPz7t1QhP68FLv5N9R4Cox", // Sanity API token
...
// Create a Sanity client instance to interact with the target Sanity dataset
    ...
    const targetClient = createClient({
        ...
        apiVersion: "2025-01-20", // Sanity API version
